...
let rubric =
[
 "infer2_exp"^" "^"env0"^" "^"con_exp1", mptest 0 (ss_pair2 infer2_exp infer2_exp_stu env0 con_exp1);

 "infer2_exp"^" "^"env1"^" "^"var_exp1", mptest 1 (ss_pair2 infer2_exp infer2_exp_stu env1 var_exp1);

 "infer2_exp"^" "^"env0"^" "^"bin_exp1", mptest 1 (ss_pair2 infer2_exp infer2_exp_stu env0 bin_exp1);

 "infer2_exp"^" "^"env0"^" "^"mon_exp1", mptest 1 (ss_pair2 infer2_exp infer2_exp_stu env0 mon_exp1);

 "infer2_exp"^" "^"env0"^" "^"if_exp1", mptest 1 (ss_pair2 infer2_exp infer2_exp_stu env0 if_exp1);

 "infer2_exp"^" "^"env0"^" "^"fun_exp1", mptest 2 (ss_pair2 infer2_exp infer2_exp_stu env0 fun_exp1);

 "infer2_exp"^" "^"env0"^" "^"app_exp1", mptest 1 (ss_pair2 infer2_exp infer2_exp_stu env0 app_exp1);

 "infer2_exp"^" "^"env0"^" "^"raise_exp1", mptest 1 (ss_pair2 infer2_exp infer2_exp_stu env0 raise_exp1);

  "infer2_exp"^" "^"env0"^" "^"letin_exp1", mptest 1 (ss_pair2 infer2_exp infer2_exp_stu env0 letin_exp1);

  "infer2_exp"^" "^"env0"^" "^"letrecin_exp1", mptest 1 (ss_pair2 infer2_exp infer2_exp_stu env0 letrecin_exp1);
...
let extra_rubric = [
 "infer2_exp"^" "^"env0"^" "^"trywith_exp1", mptest 1 (ss_pair2 infer2_exp infer2_exp_stu env0 trywith_exp1);
]
